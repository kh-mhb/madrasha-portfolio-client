      ...
      <div className="grid lg:grid-cols-3 justify-center items-center  mt-6">
        ...
        <div className="col-span-2 ..1.">
          <h3 className="leading-8 break-all font-normal px-2 sm:px-5 ">
            ...
            dedicated Teachers, and talented Students. Each plays a vital part in
            shaping our institution and fostering a positive learning environment.
            Discover their stories, achievements, and the essence of our
            educational journey.
          </h3>
        </div>
      </div>
